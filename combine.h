...
public:
	...
	bool			DynamicPropCover(); // [MODIFICATION-Dynamic Cover]
	int				CountNPCsUsingProp(CBaseEntity* pProp); // [MODIFICATION-Dynamic Cover]
...
private:
	...
	enum
	{
		...
		SCHED_COMBINE_PANIC_DROP_GRENADE, //  [MODIFICATION]
	...
	enum
	{
		...
		TASK_COMBINE_PANIC_DROP_GRENADE,// [MODIFICATION]
		TASK_COMBINE_MOVE_TO_HIGH_COVER,  // [MODIFICATION-Dynamic Cover]
		TASK_COMBINE_MOVE_TO_LOW_COVER,  // [MODIFICATION-Dynamic Cover]
	...
	enum Combine_Conds
	{
		...
		COND_COMBINE_HAS_HIGH_COVER, // [MODIFICATION-Dynamic Cover]
		COND_COMBINE_HAS_LOW_COVER, // [MODIFICATION-Dynamic Cover]
		COND_CAN_KICK_GRENADE,
		COND_CAN_RETURN_GRENADE,
		NEXT_CONDITION
	};
...
private:
	...
	// Throwback and Kick Grenaes - Main variables
	...
	float			m_flNextGrenadePanicTime;
	bool			m_bIsDoingPanicDrop;
