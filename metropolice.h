...
private:
	...
	enum
	{
		...
		COND_METROPOLICE_HAS_HIGH_COVER,
		COND_METROPOLICE_HAS_LOW_COVER,
	...
	enum
	{
		...
		SCHED_METROPOLICE_MOVE_TO_HIGH_COVER,// [MODIFICATION] -  Dynamic Cover
		SCHED_METROPOLICE_MOVE_TO_LOW_COVER, // [MODIFICATION] -  Dynamic Cover
	...
	enum 
	{
		...
		TASK_METROPOLICE_MOVE_TO_HIGH_COVER, // [MODIFICATION]
		TASK_METROPOLICE_MOVE_TO_LOW_COVER, // [MODIFICATION]
